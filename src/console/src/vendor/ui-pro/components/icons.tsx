...
export const Pencil = (props: IconProps) =>
  jsx('svg', {
    ...
    children: jsx('path', {
      fill: 'currentColor',
      fillRule: 'evenodd',
      d: 'M11.013 1.427a1.75 1.75 0 0 1 2.474 2.474l-8.368 8.368a.75.75 0 0 1-.332.2l-3.36.84a.75.75 0 0 1-.919-.92l.84-3.359a.75.75 0 0 1 .2-.332zm1.414 1.06a.25.25 0 0 0-.354 0l-7.94 7.94.14.56.56.14 7.94-7.94a.25.25 0 0 0 0-.354z',
      clipRule: 'evenodd',
    }),
  });
